...
const contPrincipal = document.querySelector('.cont_maximax');
...
function getTable(){
    ...
    console.log("El contenido de la tabla es: ",table)
    return table;
}
...
function getMatrixMaxiMax(){
    ...
    console.log("El valor de la matriz es: ",table2);
}
...
button.addEventListener('click',()=>{
    ...
    resolver.addEventListener('click',()=>{
        ...
        posMax++;
        console.log('la estrategia pos es: ', posMax)
